app.service('PdfMaker', [function() {
    ...
    this.createChart = function(personalDetails,assumptions,result){
        ...
        var columnsP1 = [
            { title: "Super Fund Comparison Calculations", dataKey: "info"},
        ];
        ...
        var rows2 = [
            { "assume": "Employer Contribution Level", "value": pcFormat.to(assumptions.ecLevel)},
            { "assume": "Super Tax Rate", "value": pcFormat.to(assumptions.superTaxRate)},
            { "assume": "Inflation", "value": pcFormat.to(assumptions.inflation)},
            { "assume": "Wage Increase", "value": pcFormat.to(assumptions.wageIncrease)},
            { "assume": "Insurance Premium per year", "value": moneyFormat.to(assumptions.insurancePremium)},
            { "assume": "Concessional Contribution", "value": moneyFormat.to(personalDetails.cc)},
            { "assume": "Non Concessional Contribution", "value": moneyFormat.to(personalDetails.ncc)},
        ];

        var columns3 = [
            { title: "Fund Details", dataKey: "details" },
            { title: "Fund A", dataKey: "fundA" },
            { title: "Fund B", dataKey: "fundB" },
        ];
        var rows3 = [
        ...
        var columns32 = [
            { title: "Final Result", dataKey: "fR" },
            { title: "Value", dataKey: "value" },
        ];
        var rows32 = [
            { "fR": "Discounted Super Balance Fund A", "value":moneyFormat.to(result.resultFundOne)},
            { "fR": "Discounted Super Balance Fund B", "value": moneyFormat.to(result.resultFundTwo)},
            { "fR": "Savings", "value": moneyFormat.to(result.savings)},
        ];
        ...
        doc.autoTable(columns3, rows3, {
          ...
          columnStyles:{
            details: {columnWidth: 150},
            fundA: {columnWidth: 185},
            fundB: {columnWidth: 185},
            },
        });
        ...
        doc.save('SuperFundComparison.pdf');
